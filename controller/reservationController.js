...
reservationController.getReservation = (req,res) => {
    try {
        ...
        reservationModel.getReservation(req, res)
    } catch (err) {
        console.log(err)
        throw err
    }
...
reservationController.getReservationId = (req,res) => {
    try {
        ...
        reservationModel.getReservationId(req, res)
    } catch (err) {
        console.log(err)
        throw err
    }
...
reservationController.addReservation = (req,res) => {
    try {
        ...
        //res.status(200).json(reservations)
        reservationModel.addReservation(req, res)
    } catch (err) {
        console.log(err)
        throw err
    }
...
reservationController.editReservation = (req,res) => {
    try {
        ...
        //res.status(200).json(reservation)
        reservationModel.editReservation(req, res)
    } catch (err) {
        console.log(err)
        throw err
    }
...
reservationController.deleteReservation = (req,res) => {
    try {
        ...
        //res.status(200).json(reservations)
        reservationModel.deleteReservation(req, res)
    } catch (err) {
        console.log(err)
        throw err
    }
